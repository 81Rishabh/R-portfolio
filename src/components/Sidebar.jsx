...
function Sidebar(props) {
  ...
  return (
     <div>
      <div className={`backdrop w-screen h-screen cursor-pointer  fixed overflow-hidden z-40 top-0 left-0 ${props.open ? 'backdrop-blur-sm' : 'backdrop-blur-none hidden'}`} 
   ...
   >
     ...
     <div className="content mt-5">
       ...
       <div
         className="colors mt-2 w-56 flex justify-start items-center gap-x-3 py-2"
         ref={PalatesRef}
       >
         <div
           className="w-6 h-6 rounded-full bg-indigo-600"
           onClick={(e) => handleThemeChange(e, "indigo")}
         ></div>
         <div
           className="w-6 h-6 rounded-full bg-teal-600"
           onClick={(e) => handleThemeChange(e, "teal")}
         ></div>
         <div
           className="w-6 h-6 rounded-full bg-cyan-600"
           onClick={(e) => handleThemeChange(e, "cyan")}
         ></div>
         <div
