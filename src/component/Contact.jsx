...
function Contact() {
  return (
    <div className="w-11/12 h-auto mx-auto my-6 rounded bg-gray-50 shadow-sm p-5 md:h-96" id="contact">
       ...
       <div class="w-full h-full md:w-5/12 mx-auto py-4 flex flex-col justify-center items-center">
          <div className="flex items-end">
              <div className="w-14 h-14 flex md:w-24 md:h-24">
               ...
               <h1 className="text-[#380D63] text-1xl font-extrabold ml-5 md:text-4xl">How to reach me ?</h1>
          </div>
