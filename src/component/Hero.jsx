...
function Hero() {
  return (
    <div className="w-11/12 h-96 mx-auto my-6 rounded bg-slate-100 shadow-sm flex justify-center items-center" id="Hero">
      <div className="w-10/12 max-auto h-5/6 pt-10 flex flex-col md:flex-row justify-around">
        <div className="content">
          <h1 className="font-light text-lg">👋 Hii There i'm</h1>
          <h1 className="font-extrabold text-4xl my-2 text-[#380D63] md:text-6xl">Rishbah Vishwakarma</h1>
          <p className="text-pink-600 text-sm md:text-lg">A <span className="text-[#380D63]">frontend developer </span>, i help Startup Launch 🚀 And grow Their product</p>
        ...
        <div className="social-icon h-40 w-28 flex flex-row justify-between md:flex-col md:justify-between mt-6 md:m-0 md:justify-around">
          <a href="https://github.com/Rishabh8109">
            <svg style={{ cursor: 'pointer' }} width="30" height="30" fill="#000" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
