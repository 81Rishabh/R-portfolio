...
function Card({item}) {
  ...
  return (
    <div className="card w-full h-auto bg-white shadow-md rounded-lg my-2 cursor:pointer md:w-96 md:h-auto">
      ...
      <div className="project-detail p-5">
        ...
        <div className="mt-5 h-24 flex items-center flex-wrap flex-col md:flex-row w-full"> 
          <button type="button" className="transition ring-offset-2 ring-2 ring-green-500 rounded-full  text-green-600 px-3 hover:bg-green-700 hover:text-white mb-3 md:m-0"><span className="text-xs">Live preview</span></button>
